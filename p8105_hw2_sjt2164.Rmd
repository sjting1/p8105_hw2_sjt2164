...
There are 356 distinct stations. 73 out of the 356 stations are ADA compliant. 38.46% of station entrances/exits without vending allow entrance. 
...
nyctransit_ent = filter(nyctransit_stn, vending_fc == "NO") #117 entrance/exits w/o vending
summary(nyctransit_ent) #Entry: 72 FALSE and 45 TRUE
```
