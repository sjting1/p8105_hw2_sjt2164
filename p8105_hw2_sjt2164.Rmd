...
Problem 2 uses the _"202309 Trash Wheel Collection Data"_ xlsx file from Mr. Trash Wheel. The dataset was imported as `mr_trash`.

```{r trash setup, include = FALSE}
mr_trash = read_excel("data/202309 Trash Wheel Collection Data.xlsx", sheet = "Mr. Trash Wheel", n_max = 584) #584r x 16c
